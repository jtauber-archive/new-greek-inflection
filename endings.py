...
SECONDARY_ACTIVE = {
    ...
    "1P": [
        ...
        f("|!>μεν"),
        f("|σ>σα+μεν"), f("|ψ>ψα+μεν"), f("|ξ>ξα+μεν"),
        f("|κ>κα+μεν"),
        f("|ρ>ρα+μεν"), f("|λ>λα+μεν"),
        f("|μ>μα+μεν"), f("|ν>να+μεν"),
    ],
    "2P": [
        f("ε+τε"), f("|ά>ᾶ<ε|+τε"), f("|έ>εῖ<ε|+τε"), f("|ή>ῆ<ε|+τε"), f("|ό>οῦ<ε|+τε"),
        f("|!>τε"),
        f("|σ>σα+τε"), f("|ξ>ξα+τε"), f("|ψ>ψα+τε"),
        f("|κ>κα+τε"),
        f("|ρ>ρα+τε"), f("|λ>λα+τε"),
        f("|μ>μα+τε"), f("|ν>να+τε"),
    ],
...
SECONDARY_MIDDLE = {
    ...
    "2S": [
        ...
        f("|!>σο"), f("|ε!>ου<+σο|"), f("|ο!>ου<+σο|"), f("|!>σθα"),
        f("|σ>σω"), f("|ξ>ξω"),
        f("|ρ>ρω"),
    ],
    "3S": [
    ...
    "1P": [
        f("ό+μεθα"), f("|α>ώ<ό|+μεθα"), f("|ε>ού<ό|+μεθα"), f("|ο>ού<ό|+μεθα"),
        f("|!>μεθα"),
        f("|σ>σα+μεθα"), f("|ξ>ξα+μεθα"), f("|ψ>ψα+μεθα"),
        f("|ρ>ρα+μεθα"),
    ],
    "2P": [
        f("ε+σθε"), f("|ά>ᾶ<ε|+σθε"), f("|έ>εῖ<ε|+σθε"), f("|ό>οῦ<ε|+σθε"),
        f("|!>σθε"),
        f("|σ>σα+σθε"), f("|ξ>ξα+σθε"), f("|ψ>ψα+σθε"),
    ],
    "3P": [
        f("ο+ντο"), f("|ά>ῶ<ο|+ντο"), f("|έ>οῦ<ο|+ντο"), f("|ό>οῦ<ο|+ντο"),
        f("|!>ντο"),
        f("|σ>σα+ντο"), f("|ξ>ξα+ντο"), f("|ψ>ψα+ντο"),
    ],
}
...
ACTIVE_SUBJUNCTIVE = {
    ...
    "2P": [
        f("η+τε"),
        f("|ά>ᾶ+τε"), f("|έ>ῆ+τε"), f("|ό>οῦ+τε"), f("|ό>ῶ+τε"),
...
ACTIVE_INFINITIVE = [
    f("ειν"),
    f("εῖν"),  # @@@
    f("|ά>ᾶν"), f("|έ>εῖν"), f("|ό>οῦν"), f("|η>ῆν"),
    f("|ό!>όναι"), f("|έ!>έναι"), f("|ά!>άναι"), f("|ῡ!>ύναι"), f("|η!>ῆναι"), f("|ω!>ῶναι"), f("|εἱ!>εἱναι"), f("|ι>ῖναι"),
    f("|ό!>οῦναι"), f("|έ!>εῖναι"),
    f("|σ>σαι"),
    f("|εσ>έσαι"), f("|ησ>ῆσαι"), f("|ωσ>ῶσαι"), f("|υσ>ῦσαι"), f("|ασ>άσαι"), f("|ουσ>οῦσαι"), f("|ισ>ίσαι"),  # @@@
    f("|ξ>ξαι"),
    f("|αξ>άξαι"), f("|οιξ>οῖξαι"), f("|ειξ>εῖξαι"),  # @@@
    f("|ψ>ψαι"),
    f("|αμψ>άμψαι"), f("|υψ>ύψαι"),  # @@@
    f("|κ>και"),
    f("|ρ>ραι"), f("|λ>λαι"),
    f("|αρ>ᾶραι"),  # @@@
    f("|ειν>εῖναι"),
...
MIDDLE_INFINITIVE = [
    ...
    f("|!>σθαι"), f("|ει!>εῖ+σθαι"), f("|η!>ῆ+σθαι"), f("|ε!>έ+σθαι"),  # @@@
    f("|σ>σα+σθαι"),
    f("|ξ>ξα+σθαι"), f("|ψ>ψα+σθαι"),
    f("|ρ>ρα+σθαι"), f("|λ>λα+σθαι"),
]
